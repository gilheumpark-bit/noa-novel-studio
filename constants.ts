...
export const TRANSLATIONS: Record<AppLanguage, any> = {
  KO: {
    ...
    directing: {
      title: "연출 시트",
      subtitle: "EPISODE DIRECTING SHEET",
      openingHook: "오프닝 훅",
      openingHookPlaceholder: "독자를 첫 문장에서 잡을 장치...",
      endingHook: "엔딩 클리프행어",
      endingHookPlaceholder: "다음 화를 클릭하게 만들 장치...",
      overallMood: "에피소드 전체 분위기",
      overallMoodPlaceholder: "어둡고 습한 / 긴박한 추격 / 따뜻한 재회...",
      addScene: "씬 추가",
      untitledScene: "제목 없는 씬",
      sceneTitle: "씬 제목",
      location: "장소",
      mood: "분위기/연출",
      moodPlaceholder: "어두운 조명, 빗소리...",
      emotion: "감정 타겟",
      emotionPlaceholder: "불안 → 공포 → 안도",
      sceneCharacters: "등장인물",
      sceneCharactersPlaceholder: "이름을 쉼표로 구분...",
      beats: "비트",
      beatDescription: "이 비트에서 일어나는 일...",
      intensity: "강도",
      dialogueNotes: "캐릭별 대사 노트",
      characterName: "캐릭터명",
    ...
    brainstorm: {
      title: "브레인스토밍",
      subtitle: "CREATIVE IDEATION ENGINE",
      customPlaceholder: "자유 주제로 아이디어를 요청하세요...",
      empty: "카테고리를 선택하거나 직접 질문을 입력하세요",
    },
    outline: {
      title: "아웃라인 보드",
      subtitle: "EPISODE OUTLINE MAP",
      done: "완료",
      drafts: "초안",
      titlePlaceholder: "에피소드 제목...",
      summaryPlaceholder: "한 줄 요약...",
      save: "저장",
      noTitle: "제목 미정",
    },
    relationship: {
      title: "캐릭터 관계도",
      descPlaceholder: "관계 설명...",
      needCharacters: "캐릭터를 2명 이상 등록하세요",
    },
    export: {
      title: "내보내기",
      txt: "TXT",
  ...
  EN: {
    ...
    directing: {
      title: "Directing Sheet",
      subtitle: "EPISODE DIRECTING SHEET",
      openingHook: "Opening Hook",
      openingHookPlaceholder: "Hook the reader from the first line...",
      endingHook: "Ending Cliffhanger",
      endingHookPlaceholder: "Make them click next episode...",
      overallMood: "Overall Episode Mood",
      overallMoodPlaceholder: "Dark & damp / tense pursuit / warm reunion...",
      addScene: "Add Scene",
      untitledScene: "Untitled Scene",
      sceneTitle: "Scene Title",
      location: "Location",
      mood: "Mood / Direction",
      moodPlaceholder: "Dim lighting, rain sounds...",
      emotion: "Emotion Target",
      emotionPlaceholder: "Anxiety → Fear → Relief",
      sceneCharacters: "Characters",
      sceneCharactersPlaceholder: "Separate names with commas...",
      beats: "Beats",
      beatDescription: "What happens in this beat...",
      intensity: "Intensity",
      dialogueNotes: "Character Dialogue Notes",
    ...
    brainstorm: {
      title: "Brainstorm",
      subtitle: "CREATIVE IDEATION ENGINE",
      customPlaceholder: "Ask for ideas on any topic...",
      empty: "Select a category or type your own question",
    },
    outline: {
      title: "Outline Board",
      subtitle: "EPISODE OUTLINE MAP",
    ...
    relationship: {
      ...
      descPlaceholder: "Describe the relationship...",
      needCharacters: "Register at least 2 characters",
    },
    export: {
      title: "Export",
      txt: "TXT",
  ...
  JP: {
    ...
    directing: {
      ...
      openingHookPlaceholder: "最初の一文で読者を掴む仕掛け...",
      endingHook: "エンディングクリフハンガー",
      endingHookPlaceholder: "次話をクリックさせる仕掛け...",
      overallMood: "エピソード全体の雰囲気",
      overallMoodPlaceholder: "暗く湿った / 緊迫した追跡 / 温かい再会...",
      addScene: "シーン追加",
      untitledScene: "無題のシーン",
      sceneTitle: "シーンタイトル",
      location: "場所",
      mood: "雰囲気/演出",
      moodPlaceholder: "薄暗い照明、雨音...",
      emotion: "感情ターゲット",
      emotionPlaceholder: "不安 → 恐怖 → 安堵",
      sceneCharacters: "登場人物",
      sceneCharactersPlaceholder: "名前をカンマで区切って...",
      beats: "ビート",
      beatDescription: "このビートで起こること...",
      intensity: "強度",
      dialogueNotes: "キャラ別台詞ノート",
    ...
    brainstorm: { title: "ブレインストーミング", subtitle: "CREATIVE IDEATION ENGINE", customPlaceholder: "自由にアイデアをリクエスト...", empty: "カテゴリを選択するか質問を入力" },
    outline: { title: "アウトラインボード", subtitle: "EPISODE OUTLINE MAP", done: "完了", drafts: "下書き", titlePlaceholder: "エピソードタイトル...", summaryPlaceholder: "一行まとめ...", save: "保存", noTitle: "未定" },
    relationship: { title: "キャラ関係図", descPlaceholder: "関係の説明...", needCharacters: "2人以上のキャラを登録してください" },
    export: { title: "エクスポート", txt: "TXT", html: "HTML (Word)", pdf: "PDF (印刷)", json: "JSONバックアップ", import: "JSONインポート" },
    writing: {
  ...
  CN: {
    ...
    directing: {
      ...
      subtitle: "EPISODE DIRECTING SHEET",
      openingHook: "开场钩子",
      openingHookPlaceholder: "第一句话就抓住读者的装置...",
      endingHook: "结尾悬念",
      endingHookPlaceholder: "让读者点击下一话的装置...",
      overallMood: "整集氛围",
      overallMoodPlaceholder: "阴暗潮湿 / 紧张追逐 / 温暖重逢...",
      addScene: "添加场景",
      untitledScene: "未命名场景",
      sceneTitle: "场景标题",
      location: "地点",
      mood: "氛围/导演",
      moodPlaceholder: "昏暗灯光、雨声...",
      emotion: "情感目标",
      emotionPlaceholder: "不安 → 恐惧 → 释然",
      sceneCharacters: "出场人物",
      sceneCharactersPlaceholder: "用逗号分隔名字...",
      beats: "节拍",
      beatDescription: "这个节拍中发生的事情...",
      intensity: "强度",
      dialogueNotes: "角色台词笔记",
      characterName: "角色",
    ...
    brainstorm: { title: "头脑风暴", subtitle: "CREATIVE IDEATION ENGINE", customPlaceholder: "自由请求创意...", empty: "选择类别或输入问题" },
    outline: { title: "大纲板", subtitle: "EPISODE OUTLINE MAP", done: "完成", drafts: "草稿", titlePlaceholder: "集标题...", summaryPlaceholder: "一句话总结...", save: "保存", noTitle: "未定" },
    relationship: { title: "角色关系图", descPlaceholder: "关系描述...", needCharacters: "请注册至少2个角色" },
    export: { title: "导出", txt: "TXT", html: "HTML (Word)", pdf: "PDF (打印)", json: "JSON备份", import: "导入JSON" },
    writing: {
      ready: "神经接口已连接",
